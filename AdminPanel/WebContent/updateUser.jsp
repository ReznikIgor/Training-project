	...
	<div>
		...
		<form action="updUser" method="post">
			<table class="text">
				<tr>
					<td>Username:</td>
					<td class="rightcol"><input type="hidden" name="resentId"
						value="${resentId}"> <input type="text" name="username" /><br></td>
				</tr>
				<tr>
					<td>Password:</td>
				...
				<tr>
					<td></td>
					<td class="leftcol"><select name="Role" size="1">
				...
				<tr>
					<td></td>
					<td class="rightcol"><input type="submit" value="Update now"><input
